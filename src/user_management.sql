...
SELECT first_name ||' ' || last_name AS members
FROM members;

-- -- 2. Update a member's contact information
-- -- TODO: Write a query to update a member's contact information
UPDATE members
SET email='alice.j1@email.com', phone_number='555-1112'
WHERE member_id = 1 OR email='alice.j@email.com'; -- included email for a 2nd option as is also a unique key
